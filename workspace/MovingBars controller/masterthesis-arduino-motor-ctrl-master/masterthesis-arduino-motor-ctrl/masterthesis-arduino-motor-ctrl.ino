...
void loop() {  
  ...
  debug.println("button1=",analogRead(A2));
}
...
void parseMessage(String msg) {
  ...
  if (cmd.indexOf("MOVE") > -1) {
   ...
   debug.println("IR value=", ctl.getIRValue());
   debug.println("button1 value=", ctl.getButton1Value());
   debug.println("button2 value=", ctl.getButton2Value());
