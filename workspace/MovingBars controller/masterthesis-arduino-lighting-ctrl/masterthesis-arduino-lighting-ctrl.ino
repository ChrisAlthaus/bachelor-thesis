...
void parseMessage(String msg) {
  ...
  if (cmd.indexOf("LIGHT") > -1) {
    ...
    setAnimation(lighting[0], rgba, spd);
      ...
      int level = lighting[0].toInt();
      debug.println("Level:", level);
  
      String color = lighting[1];
      debug.println("Color:", color);
  
      int brightness = lighting[2].toInt();
      debug.println("Brightness:", brightness);
      ...
      // Update Lighting Pattern
       ...
       //led.setLED("A",level,ALA_ON,AlaColor(rgba[0], rgba[1], rgba[2]));
       //led.setLED("B",level,ALA_ON,AlaColor(rgba[0], rgba[1], rgba[2]));
       //led.setLED("C",level,ALA_ON,AlaColor(rgba[0], rgba[1], rgba[2]));
       //led.setLED("D",level,ALA_ON,AlaColor(rgba[0], rgba[1], rgba[2]));
